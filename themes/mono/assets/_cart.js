class CartBubble extends HTMLElement {
  ...
  updateCount(count) {
    const previousCount = parseInt(this.textContent, 10) || 0;
    ...
    if (count > previousCount) {
      ...
      requestAnimationFrame(() => {
        this.setAttribute("data-pulse", "true");
        setTimeout(() => this.removeAttribute("data-pulse"), 4000);
      });
    }
  }
}
...
class CartSummary extends HTMLElement {
  ...
  constructor() {
    ...
    this.appliedArea = this.querySelector('[ui-summary-box="applied-area"]');
  ...
  setShowCouponInSummary(shouldShow) {
    this.appliedArea?.toggleAttribute("hidden", !shouldShow);
  }
